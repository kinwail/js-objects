...
var dog = {
    ...
    age: '34',
    vegeterian: false,
    color: ['dark', 'hella dark'],
    speak: function(){
        return 'bark'
    }
}

console.log('My dog ' + dog.name + ' is ' + dog.age + ' year old and likes to ' + dog.speak() + ' at stranger')
//An empty object
...
var completePerson = buildPerson(plainPerson, 'Jasen', 34);
